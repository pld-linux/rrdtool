...
sk≥adowanie i wy∂wietlanie czasowych serii danych (np. przepustowo∂Ê 
sieci, temperatura w pomieszczeniu, obci±øenie servera). Sk≥aduje dane
w "skondensowanej" postaci, ktÛra nie rozrasta siÍ z biegiem czasu oraz
pozwala na produkowanie wykresÛw z uøytecznymi danymi. Moøe byÊ uøywane 
poprzez prosty skrypcik (shell lub perl), frontendy czy inne 
interfejsy uøytkownika.
